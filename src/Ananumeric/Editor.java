...
public class Editor extends JInternalFrame {
	...
	public void menus () {
		...
		JMenuItem nue= new JMenuItem("Nuevo", new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\hoja_6.gif"));
		...
		JMenuItem sal= new JMenuItem("Salir",new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\salir.gif"));
		...
		JMenuItem abr= new JMenuItem("Abrir",new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\libro_1.gif"));
		...
		JMenuItem guar= new JMenuItem("Guardar",new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\guardar.gif"));
		...
		JMenuItem cor= new JMenuItem("Cortar", new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\cut.gif"));
		...
		JMenuItem cop= new JMenuItem("Copiar",new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\copiar_0.gif"));
		...
		JMenuItem peg= new JMenuItem ("Pegar",new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\paste.gif"));
		...
		JMenuItem fuen= new JMenuItem("Tamaño de fuente",new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\hoja_2.gif"));
		...
		JMenuItem ayu= new JMenuItem("Ayuda",new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\bombillo.gif"));
		...
		JMenuItem acer= new JMenuItem("Acerca de...",new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\chulo.gif"));
	...
	public void barra () {
		...
		nue= new JButton ();
		nue.setIcon(new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\hoja_6.gif"));
		...
		ab= new JButton();
		ab.setIcon(new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\libro_1.gif"));
		...
		gua= new JButton();
		gua.setIcon(new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\guardar.gif"));
		...
		cor= new JButton();
		cor.setIcon(new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\cut.gif"));
		...
		cop= new JButton();
		cop.setIcon(new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\copiar_0.gif"));
		...
		peg= new JButton();
		peg.setIcon(new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\paste.gif"));
		...
		del.setIcon(new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\borrador.gif"));
		...
		ayuda= new JButton();
		ayuda.setIcon(new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\bombillo.gif"));
		...
		acerca= new JButton();
		acerca.setIcon(new ImageIcon("C:\\ELRO Lta\\src\\Imágenes\\Images\\chulo.gif"));
	...
	public void acerca () {
		JOptionPane.showMessageDialog(null,"Editor de textos\nDesarrollado por:  Elvin Gregorio\nIngeniería de sistemas\nUniversidad Nacional de Ingeniería\nE-mail:  love13football@hotmail.com");
	}
